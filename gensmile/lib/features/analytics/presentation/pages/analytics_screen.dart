          ...
          child: Column(
            ...
            children: [
              ...
              if (embedded) ...[
                ...
                Gap(2.h),
                Text(
                  'Track performance, patient insights, and revenue in real time',
                  style: GoogleFonts.inter(
                    fontSize: 12.sp,
                    color: AppColors.gray,
                  ),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: _MiniMetricCard(label: 'Total Patients', value: '1,284'),
            ),
            SizedBox(width: 10.w),
            Expanded(
              child: _MiniMetricCard(label: 'Total Simulations', value: '42'),
            ),
          ],
        ),
        Gap(10.h),
        Row(
          children: [
            Expanded(
              child: _MiniMetricCard(label: 'Active Cases', value: '15'),
            ),
            SizedBox(width: 10.w),
            Expanded(
              child: _MiniMetricCard(label: 'Completed Cases', value: '432'),
            ),
          ],
        ),
        Gap(20.h),
