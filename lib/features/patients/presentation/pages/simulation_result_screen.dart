...
import 'package:gen_smile/features/patients/presentation/pages/send_result_screen.dart';
...
class _SimulationResultScreenState
  ...
  // FIX 5: track whether we are currently navigating to prevent double-pop freeze
  ...
  Widget build(BuildContext context) {
    ...
    // FIX 5: WillPopScope prevents the OS back gesture from double-firing
    return WillPopScope(
      onWillPop: () async {
            ...
            Container(
              ...
              child: SafeArea(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      // FIX 5: back button uses _safeBack
                      GestureDetector(
                        onTap: _safeBack,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Preview the potential smile transformation',
                              style: GoogleFonts.inter(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children:
                                  SimulationResultScreen._views.map((v) {
                                final isActive = activeView == v;
                                return Expanded(
                                  child: GestureDetector(
                                    onTap: () => ref
                                        .read(simResultViewProvider.notifier)
                                        .state = v,
                                    child: Container(
                                      padding: EdgeInsets.symmetric(
                                          vertical: 9.h),
                        ...
                        : Row(
                            ...
                            children: [
                              ...
                              _IconCircleBtn(
                                  ...
                                  filled: false,
                                  onTap: () {}),
                              // FIX 5: Run New Simulation goes back cleanly
                              _IconCircleBtn(
                                  icon: Icons.refresh_outlined,
                                  filled: false,
                                  onTap: _safeBack),
...
// ── Sub-widgets (unchanged logic, kept intact) ────────────────────────────────
...
class _IconCircleBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Container(
          ...
          child: Icon(icon,
              size: 20.sp,
              color: filled ? Colors.white : AppColors.gray),
        ),
      );
}
